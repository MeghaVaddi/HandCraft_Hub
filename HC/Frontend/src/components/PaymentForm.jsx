                    ...
                    const orderResponse = await axios.post(
                        `${import.meta.env.VITE_API_BASE_URL}/api/order/add`,
                        {
                            items: cartItems.map(item => ({
                                ...
                                img: item.productId.img?.startsWith("http")
        ? item.productId.img
        : `${import.meta.env.VITE_API_BASE_URL}/uploads/${item.productId.img}`
                    ...
                    setOrderData({
                        ...
                        items: cartItems.map(item => ({
                            ...
                            quantity: item.quantity,
                            price: Number(item.productId.price.replace(/[^0-9.-]+/g, "")),
                            img: `${import.meta.env.VITE_API_BASE_URL}/uploads/${item.productId.img}`
