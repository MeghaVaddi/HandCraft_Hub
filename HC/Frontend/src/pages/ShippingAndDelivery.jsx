        ...
        <div className="w-full mx-auto bg-white text-gray-800">
            ...
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-0 py-4 sm:py-8 text-justify space-y-4">
                <p className="text-base leading-relaxed">
                    At Hands&Craft, we strive to ensure your orders are delivered to you safely and on time. This Shipping & Delivery policy outlines our shipping methods, timelines, charges, and other related information.
                </p>
